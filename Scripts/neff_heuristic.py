...
t1w_moco = create_key('sub-{subject}/{session}/anat/sub-{subject}_{session}_rec-moco_T1w')
...
b0_phase2 = create_key('sub-{subject}/{session}/fmap/sub-{subject}_{session}_phase{item}')
...
def infotodict(seqinfo):
    ...
    info = {t1w: [], t1w_nav: [], t1w_sag:[], effort_01: [], effort_02: [], effort_03: [], effort_04: [],
            b0_mag: [], b0_phase: [], effort_sbref: [], t1w_moco: [], b0_phase2: []
            }
    for s in seqinfo:
        ...
        if ("mprage" in protocol): 
            ...
            if ("MPRAGE_NAVprotocol" in s.series_description):
        ...
        # b0 maps
            ...
            if 'e1_ph' in s.dcm_dir_name.lower() or 'e2_ph' in s.dcm_dir_name.lower():
                info[b0_phase2].append(s.series_id)
            else:
