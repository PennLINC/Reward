# seriesNumber = s.series_number ;;; may be useful for differentiating resting state runs 
...
def infotodict(seqinfo):
    ...
    info = {t1w: [], t1w_nav: [], t1w_sag: [], card_01: [], card_02: [], itc_01: [], itc_02: [], 
            b0_mag: [], b0_phase: [], rest_sb124: [], rest_sb204: [],rest_mb: []
            }
    for s in seqinfo:
        ...
        # resting-state
            ...
            if (("MB" in s.image_type) or ("mb" in s.series_description)):
                info[rest_mb].append(s.series_id)
            elif "124" in protocol:
                info[rest_sb124].append(s.series_id)
            elif "204" in protocol:
                info[rest_sb204].append(s.series_id)
    return info

IntendedFor = {
    b0_mag: [
        '{session}/func/sub-{subject}_{session}_task-rest_acq-singleband124_bold.nii.gz',
        '{session}/func/sub-{subject}_{session}_task-rest_acq-singleband204_bold.nii.gz',
